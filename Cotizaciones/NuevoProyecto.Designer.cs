namespace Cotizaciones
{
	partial class NuevoProyecto
	{
		...
		private void InitializeComponent()
		{
			...
			// textBox1
			// 
			textBox1.Location = new Point(205, 29);
			...
			// textBox2
			// 
			textBox2.Location = new Point(205, 74);
			textBox2.Multiline = true;
			textBox2.Name = "textBox2";
			textBox2.Size = new Size(361, 82);
			textBox2.TabIndex = 3;
			textBox2.TextChanged += textBox2_TextChanged;
			// 
			// btnGuardarProyecto
			// 
			btnGuardarProyecto.Location = new Point(293, 239);
			btnGuardarProyecto.Name = "btnGuardarProyecto";
			btnGuardarProyecto.Size = new Size(125, 40);
